...
#sym.var('c_S (C-c_S) nu xi eta_mS eta_pS eta_mNS eta_pNS k_mS k_pS k_mNS k_pNS r_m r_p',real=True)
...
Q = sym.Matrix([[-c_S*k_pS-(C-c_S)*k_pNS-r_p, c_S*k_pS, (C-c_S)*k_pNS, 0, 0, r_p],
               ...
               [xi*r_m, 0, 0, c_S*eta_pS*k_pS, (C-c_S)*eta_pNS*k_pNS, -xi*r_m-c_S*eta_pS*k_pS-(C-c_S)*eta_pNS*k_pNS]])
...
vars_to_save = ['c_S','(C-c_S)','nu','xi','eta_mS','eta_pS','eta_mNS','eta_pNS','k_mS','k_pS','k_mNS','k_pNS','r_m','r_p',
