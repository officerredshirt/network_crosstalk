...
# ARCHITECTURE
N_PF = 100#5      # number pioneer factors
N_TF = 100#10     # number transcription factors
M_ENH = 100   # number enhancers
M_GENE = 100  # number genes
THETA = 1#3     # number TFs per enhancer
n = 1         # number binding sites per TF

# EQUILIBRIUM TF BINDING
K_S = 10      # TF specific binding constant
K_NS = 100000#10000  # TF nonspecific binding constant
